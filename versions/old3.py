"""
This is version 1.4.1 Dated: 19/09/2020
...
class AddressPanel(wx.Panel):
    def __init__(self, parent):
        ...
        name_stc_txt = wx.StaticText(self, label='Name: ')
        name_txt_cntrl = wx.TextCtrl(self)
        name_sizer.Add(name_stc_txt, 0, wx.ALL, 5)
        name_sizer.Add(name_txt_cntrl, 0, wx.ALL, 5)

        address_sizer = wx.BoxSizer(wx.HORIZONTAL)
        address_stc_txt = wx.StaticText(self, label='Address: ')
        address_txt_cntrl = wx.TextCtrl(self)
        address_sizer.Add(address_stc_txt, 0, wx.ALL, 5)
        address_sizer.Add(address_txt_cntrl, 5, wx.ALL | wx.EXPAND, 5)

        outer_sizer.Add(name_sizer, 0, wx.ALL, 5)
        outer_sizer.Add(address_sizer, 0, wx.ALL, 5)
