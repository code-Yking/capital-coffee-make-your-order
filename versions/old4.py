"""
This is version 1.4.4 Dated: 19/09/2020
This version lacks proper summarisation of size and additives of the drinks.
A cumulative summary has been tried, with some errors.
A customer details panel has been added upon change in plans.
The size of the window has been regulated.
"""
...
class AddressPanel(wx.Panel):
    def __init__(self, parent):
        ...
        self.address_txt_cntrl = wx.TextCtrl(self)
...
class Coffees(wx.Panel):
    def __init__(self, parent, no=1):
        ...
        self.available_additives = list(ADDITIVES)  # todo is available needed?
...
class Choices(wx.Panel):
    def __init__(self, parent):
        ...
        self.cancel_btn = wx.Button(self, label='Reset')
        ...
        self.next_btn = wx.Button(self, label='Cancel')
        ...
        self.choices_sizer.Add(self.next_btn, 0, wx.ALL | wx.ALIGN_RIGHT, 5)
...
class Summary(wx.Panel):
    def __init__(self, parent):
        ...
        txt = wx.StaticText(self, label="As coffees are selected their overview would be found here",
...
class MainPanel(wx.Panel):
    ...
    def summary_refresh(self, event):
        ...
        for n in self.choices_panel.coffees_outer_panel.outer_sizer.GetChildren():
            summary_coffees[n.GetWindow().coffee_combo.GetValue()] = n.GetWindow().size_combo.GetValue()
...
class MainFrame(wx.Frame):
    def __init__(self):
        super().__init__(parent=None, title="Coffee Order", size=(672,431))
